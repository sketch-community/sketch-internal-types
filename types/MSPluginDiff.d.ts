...
declare namespace sketchInternal {
  interface MSPluginDiff extends NSObject {
    /* typeEncoding=@"NSArray", ivar=_changes, attributes=(assign,nonatomic,readonly) */
    	changes(): cocoascript.NSArray;
    /* typeEncoding=@"MSDocumentData", ivar=_currentDoc, attributes=(retain,nonatomic) */
    	currentDoc(): MSDocumentData;
...
declare const MSPluginDiff: sketchInternal.MSPluginDiff;
