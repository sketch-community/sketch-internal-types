...
declare namespace sketchInternal {
  interface MSStartServiceLog extends MSAbstractLog {
    /* typeEncoding=@"NSArray", ivar=_services, attributes=(retain,nonatomic) */
...
declare const MSStartServiceLog: sketchInternal.MSStartServiceLog;
