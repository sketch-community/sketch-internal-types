...
declare namespace sketchInternal {
  interface MSSpecialLayerViewController extends MSNestedInspectorSection {
    ...
    /* typeEncoding=@"NSArray", ivar=_layerInspectorSections, attributes=(retain,nonatomic) */
    	layerInspectorSections(): cocoascript.NSArray;
    ...
    /* typeEncoding=@"NSCache", ivar=_sectionInterfaceCache, attributes=(retain,nonatomic) */
    	sectionInterfaceCache(): cocoascript.NSCache;
...
declare const MSSpecialLayerViewController: sketchInternal.MSSpecialLayerViewController;
