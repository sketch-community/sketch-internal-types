...
declare namespace sketchInternal {
  interface MSArtboardBackgroundColorInspectorItem extends MSInspectorItem {
    ...
    /* typeEncoding=@"NSButton", ivar=_colorCheckbox, attributes=(retain,nonatomic) */
    	colorCheckbox(): cocoascript.NSButton;
    ...
    /* typeEncoding=c40@0:8@16@24@32 */
    	inspectorValueAdaptor_value_isEqualToValue(...args: any[]): any;
    /* typeEncoding=@16@0:8 */
...
declare const MSArtboardBackgroundColorInspectorItem: sketchInternal.MSArtboardBackgroundColorInspectorItem;
