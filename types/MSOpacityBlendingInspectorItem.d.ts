...
declare namespace sketchInternal {
  interface MSOpacityBlendingInspectorItem extends MSInspectorItem {
    ...
    /* typeEncoding=@"NSPopUpButton", ivar=_blendModePopUp, attributes=(retain,nonatomic) */
    	blendModePopUp(): cocoascript.NSPopUpButton;
...
declare const MSOpacityBlendingInspectorItem: sketchInternal.MSOpacityBlendingInspectorItem;
