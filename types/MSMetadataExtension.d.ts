...
declare namespace sketchInternal {
  interface MSMetadataExtension extends NSObject {
    /* typeEncoding=@"NSDictionary", ivar=_metadata, attributes=(copy) */
...
declare const MSMetadataExtension: sketchInternal.MSMetadataExtension;
