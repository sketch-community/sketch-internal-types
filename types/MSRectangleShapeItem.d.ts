...
declare namespace sketchInternal {
  interface MSRectangleShapeItem extends MSCustomShapeItem {
    /* typeEncoding=@"NSPopUpButton", ivar=_curvaturePopup, attributes=(retain,nonatomic) */
    	curvaturePopup(): cocoascript.NSPopUpButton;
    ...
    /* typeEncoding=v24@0:8@16 */
    	sliderAction(...args: any[]): any;
    /* typeEncoding=v16@0:8 */
    	updateCurvaturePopupTitle(): void;
    /* typeEncoding=v16@0:8 */
    	updateDisplayedValues(): void;
    /* typeEncoding=v16@0:8 */
    	updateRadiusAdaptor(): void;
    /* typeEncoding=v16@0:8 */
    	viewDidLoad(): void;
  }
}

declare const MSRectangleShapeItem: sketchInternal.MSRectangleShapeItem;
