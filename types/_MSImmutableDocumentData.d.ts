...
declare namespace sketchInternal {
  interface _MSImmutableDocumentData extends MSImmutableModelObject {
    ...
    /* typeEncoding=@"MSImmutablePatchInfo", ivar=_patchInfo, attributes=(retain,nonatomic) */
    	patchInfo(): MSImmutablePatchInfo;
    /* typeEncoding=@"MSImmutableSwatchContainer", ivar=_sharedSwatches, attributes=(retain,nonatomic) */
    	sharedSwatches(): MSImmutableSwatchContainer;
...
declare const _MSImmutableDocumentData: sketchInternal._MSImmutableDocumentData;
